      ...
      <div class="owl-carousel products__slider owl-theme">
        ...
        <div class="products__item">
          <div class="product__header mb-3">
            <a href="{{route('shop.show',$product->id)}}">
              <div class="product__img-cont">
                <img class="product__img w-100 h-100 object-fit-cover" src="{{asset("front")}}/assets/images/{{$product->image}}" data-id="white">
              </div>
            </a>
          ...
          <div class="product__title text-center">
            <a class="text-black text-decoration-none" href="{{route("shop.show",$product->id)}}">
              {{$product['name']}}
            </a>
          </div>
        ...
        @endforeach
         {{-- <div class="products__item">
          ...
          <div class="product__title text-center">
            <a class="text-black text-decoration-none" href="{{route("shop.show")}}">
        ...
        <div class="products__item">
          <div class="product__header mb-3">
            <a href="{{route("shop.show")}}">
              <div class="product__img-cont">
                <img class="product__img w-100 h-100 object-fit-cover" src="{{asset("front")}}/assets/images/product-5.webp" data-id="white">
              </div>
            </a>
            <div class="product__sale position-absolute top-0 start-0 m-1 px-2 py-1 rounded-1 text-white">
              وفر 10%
